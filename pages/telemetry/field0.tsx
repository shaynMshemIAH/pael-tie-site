// pages/telemetry/field0.tsx
import useSWR from 'swr';
const fetcher = (u:string)=>fetch(u).then(r=>r.json());

export default function Field0() {
  const { data } = useSWR('/api/field/0', fetcher, { refreshInterval: 1500 });
  ...
  return (
    <div className="p-6 space-y-6">
      <h1 className="text-2xl font-semibold">Field 0</h1>
