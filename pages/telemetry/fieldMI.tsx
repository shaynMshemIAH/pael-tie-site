// pages/telemetry/fieldMI.tsx
import useSWR from 'swr';
const fetcher = (u:string)=>fetch(u).then(r=>r.json());

export default function FieldMI() {
  const { data } = useSWR('/api/field/MI', fetcher, { refreshInterval: 1500 });
  ...
  return (
    <div className="p-6 space-y-6">
      <h1 className="text-2xl font-semibold">Field MI</h1>
